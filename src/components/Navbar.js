...
const Navbar = () => {
  return (
    <div className="hidden lg:block">
      {/* Match HeaderMain horizontal centering */}
      <div className="w-full px-4">
        <div className="mx-auto max-w-6xl">
          <div className="flex justify-center">
            <div className="flex w-fit gap-10 py-4 font-medium text-blackish">
              ...
              <div className="navbar__link relative cursor-pointer">WATCHES</div>
              <div className="navbar__link relative cursor-pointer">ACCESSORIES</div>
